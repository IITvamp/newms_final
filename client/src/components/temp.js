  ...
  <div class="wrapper pt-10">
    ...
    <div class="flex items-center justify-center py-8">
      <button id="theme-toggle" type="button"
        ...
        <svg id="theme-toggle-dark-icon" class="hidden fill-yellow-400 w-7 h-7" fill="currentColor" viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg">
          <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
        </svg>
        <svg id="theme-toggle-light-icon" class="hidden fill-yellow-400 w-7 h-7" fill="currentColor" viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg">
          <path
