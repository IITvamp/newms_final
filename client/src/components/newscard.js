...
const Newscard = props => {
    ...
    return (
      <div className="flex lg:justify-end flex-col md:flex-row justify-center h-full">
        <div className="box-border h-full">
          <article className="mb-4 break-inside p-6 rounded-xl bg-black dark:bg-slate-800 flex flex-col bg-clip-border">
            <div className="flex pb-6 items-center justify-between">
              <div className="flex">
                <a className="inline-block mr-2" href="#">
                  <img
                    className="rounded-full max-w-none w-6 h-6"
                    src={post.user.avatar}
                  />
                </a>
                <div>
                  <a
                    className="inline-block text-[10px] font-bold dark:text-white mr-2"
            ...
            <p className="dark:text-slate-200">{post.content}</p>
            <div className="pt-4 flex justify-start gap-2">
              <div className="border-white border-1 min-w-fit px-2">
        ...
        {/* <div className="box-border w-full sm:w-1/2 md:w-1/3 mt-16 sm:mr-8 h-4/5">
          <article className="mb-4 break-inside p-6 rounded-xl bg-black dark:bg-slate-800 flex flex-col bg-clip-border">
